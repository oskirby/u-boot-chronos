...
#define PINCTRLx_BASE                   0x48140800
...
#define PLL_VIDEO1_BASE                 (PLL_REG_BASE + 0x01D0)
...
#define DEFAULT_LOGO_TIME               30
#define MAX_LOGO_TIME                   30
...
#define VPS_COMP_HDMI_VOUT0             (VPS_REG_BASE + 0x5208)
#define VPS_COMP_DVO2                   (VPS_REG_BASE + 0x520C)
